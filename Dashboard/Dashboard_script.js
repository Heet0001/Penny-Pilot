...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Navigation function with fade effect
    function navigateTo(page) {
        document.body.classList.add("fade-out"); // Apply fade-out animation
        setTimeout(() => {
            window.location.href = page; // Redirect after animation
    ...
    // Add navigation for bottom buttons
    ...
    navButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            switch(buttonText) {
                case 'expenditure':
                    navigateTo('expenditure.html');
                    break;
                case 'debts':
                    navigateTo('debts.html');
                    break;
                case 'investments':
                    navigateTo('investments.html');
                    break;
                case 'transfer money':
                    navigateTo('transfer.html');
                    break;
                default:
                    console.log('No navigation defined for this button');
            }
        });
    });
});