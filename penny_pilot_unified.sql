...
CREATE TABLE IF NOT EXISTS credit_entries (
    ...
    category ENUM('Salary', 'Debt Taken', 'Investments Relieved', 'From Emergency', 'Other', 'Debt Given', 'Money Transfer') NOT NULL,
...
CREATE TABLE IF NOT EXISTS debit_entries (
    ...
    amount DECIMAL(10, 2) NOT NULL,
    category ENUM('Food', 'Transport', 'Entertainment', 'Bills', 'Emergency', 'Other', 'Debt Given', 'Debt Taken', 'Payroll', 'Inventory Purchase', 'Money Transfer') NOT NULL,
    entry_date DATE NOT NULL,
    description TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
